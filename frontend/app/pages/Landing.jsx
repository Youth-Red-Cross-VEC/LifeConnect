    ...
    <>
      ...
      <section className="bg-red-700 text-white flex flex-col md:flex-row items-center justify-between px-6 py-10">
        <div className="relative mb-12 md:mb-0">
          <p className="text-4xl font-light absolute top-29.25">Movement</p>
          <p className="text-5xl font-bold absolute top-13.5">Life-Saving</p>
          <p className="text-4xl font-light absolute top-0">Join the</p>
        </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2">
            ...
            <div className="flex flex-wrap gap-3">
              <CTA href="/request-blood" text="Request a blood" />
